...
import analizadores.ALexico.Token;
...
public class ASinSem {
    ...
    private Atrib x() {
        ...
        } else if (nombre().equals("puntoComa")) {
            imprimir(24);
            x = new Atrib("vacio");
        }
        return x;
    ...
    private Atrib e_() {
        ...
        } else if (nombre().equals("puntoComa") || nombre().equals("pCerrado") || nombre().equals("coma")) {
            imprimir(38);
            e_ = new Atrib("vacio");
        }
        return e_;
